 import Foundation
 public class i2iCellWebService {
    public var Url:String = "http://68.183.75.84:8080/i2iCellService/services/Services?wsdl"
    public var Host:String = "68.183.75.84:8080"
    ...
    public func isAuthorized(userId:String, password:String)-> Bool{
        ...
        //buradan servis ayarlarını tanımla
        ...
        //servis tanımlanacak
        let soapAction :String = "http://68.183.75.84:8080/i2iCellService/services/Services?wsdl"
